{{-- <nav class="navbar navbar-expand-md navbar-light bg-white shadow-sm">
    <!-- button navbar garis 3 responsive -->
    <button id="sidebarToggleTop" type="button" class="navbar-toggler mr-3">
                ...
                <a class="nav-link dropdown-toggle" href="#" id="userDropdown" role="button" data-toggle="dropdown"
                    ...
                    @if (auth()->user()->foto === null)
                        <img src="{{ asset('assets/img/default-profile.png') }}" alt="{{ auth()->user()->name }}"
                            class="img-profile rounded-circle" style="width: 40px; height: 40px;">
                    @else
