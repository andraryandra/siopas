...
@section('content')
    ...
    <div class="card shadow mb-4">
        <div class="card-header py-3">
            <div class="row">
                <div class="col-6">
                    <h5 class="m-0 font-weight-bold text-primary mt-2">Asset Management</h5>
                </div>
                <div class="col-6 text-right">
                    @can('asset-create')
                        <a href="{{ route('dashboard.asset.create') }}" class="btn btn-success btn-icon-split">
                            <span class="text">Create New Asset</span>
                        </a>
                    @endcan
                </div>
            </div>
